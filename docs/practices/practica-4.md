# Práctica 4 - Encender y apagar 5 LED's

**Nivel:** Fácil  
**Duración:** 15 minutos

## Objetivo
Programar el Photon 2 para encender y apagar 5 LEDs conectados a los pines digitales D10, D7, D6, D5 y D4, generando un efecto de desplazamiento de luz en ambos sentidos (ida y regreso)
...
## Resultado Esperado
Se espera que los LEDs se enciendan de manera secuencial desde el pin D10 hasta el D4 y posteriormente regresen en sentido contrario, generando un efecto visual de ida y vuelta.

## Evidencia
![Practica 4](../assets/images/practica4.jpeg)

![Captura Web IDE](../assets/images/practica4-captura.jpeg)

## Ver Video
<video width="50%" controls>
  <source src="/manual-iot/assets/videos/practica4.mp4" type="video/mp4">
